...
const Dashboard = () => {
    ...
    // استدعاء البيانات والدوال من الستور الجديد
    const { 
        user, 
        currentMode, 
        setCurrentMode, 
    ...
    // إعدادات العرض بناءً على الوضع الحالي (لأغراض التصميم فقط)
    ...
    // طلب تحديث المهام من الـ AI عند تحميل الصفحة أو تغيير الوضع
    useEffect(() => {
        refreshDashboard();
    }, [currentMode]);

    // أنيميشن القائمة عند تحديث المهام
    useEffect(() => {
        ...
        <>
            ...
            <div className="min-h-screen bg-slate-950 text-white font-sans pt-24">
                ...
                <main className="relative z-10 p-8 max-w-7xl mx-auto">
                            ...
                            <div className="relative overflow-hidden">
                                ...
                                <div className="relative z-10 text-center">
                                    ...
                                    <div className="relative w-48 h-48 mx-auto mb-6">
                                        <div
                                            ref={orbRef}
                                            className={`absolute inset-0 rounded-full bg-gradient-to-br ${modeStyle.color} blur-md animate-pulse`}
                                        />
                    ...
                    {/* Smart Task Queue (AI Generated) */}
                    <div className="mb-8">
                        <AnimatedCard className="glass rounded-3xl p-8 border border-white/10">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-2xl font-bold">{t('dashboard.smartQueue')}</h3>
                                {isAnalyzing && <span className="text-sm text-neon-blue animate-pulse">الذكاء الاصطناعي يحلل حالتك...</span>}
                            </div>

                            <div ref={taskListRef} className="space-y-3">
                                {dailyTasks.length === 0 && !isAnalyzing ? (
                                    <div className="text-center text-gray-500 py-4">جاري تحضير مهامك...</div>
                                ) : (
